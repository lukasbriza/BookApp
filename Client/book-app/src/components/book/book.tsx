                        ...
                        return(
                            <li className="BookLi" id={this.props.id} data-description={this.props.description}>
                                ...
                                <div className="controlArea">
                                    <Link   className="button_show" 
                                            to="/bookApp/bookOverview" 
                                            onClick={()=>{context.showOverview({
                                                                                id: this.props.id,
                                    ...
                                    <Link   className="button_edit" 
                                            to="/bookApp/bookEdit" 
                                            onClick={()=>{context.showEditPage({
                                                                                id:this.props.id, 
                                                                                name:this.props.name, 
                                                                                author: this.props.author,
                                                                                description: this.props.description
...
const EditIcon :React.FC = () => {
    return(
        <img alt="" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABgAAAAYCAYAAADgdz
...
const RemoveIcon :React.FC = () => {
    return(
        <img alt="" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABgAAAAYCAYAAADgdz3
